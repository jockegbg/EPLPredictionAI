...
return [
    ...
    'actions' => [
        ...
        'configure_ceremony_step_manager_factory' => \App\Actions\ConfigureCeremonyStepManagerFactory::class,
    ],
    ...
    'relying_party' => [
        ...
        'id' => env('PASSKEY_RP_ID', parse_url(env('APP_URL', 'http://localhost'), PHP_URL_HOST)),
        'icon' => null,
    ],
