            ...
            <div class="bg-white/10 backdrop-blur-md overflow-hidden shadow-sm sm:rounded-lg border border-white/20">
                <div class="p-6 text-white">
                    <form method="POST" action="{{ route('admin.tournaments.update', $tournament) }}">
                        ...
                        <!-- Name -->
                        <div class="mb-4">
                            <x-input-label for="name" :value="__('Tournament Name')" class="text-white" />
                            <x-text-input id="name" class="block mt-1 w-full bg-slate-700 border-gray-600 text-white"
                                type="text" name="name" :value="old('name', $tournament->name)" required autofocus />
                                ...
                                @foreach($users as $user)
                                    <label
                                        ...
                                        <input type="checkbox" name="users[]" value="{{ $user->id }}"
                                            ...
                                            {{ (is_array(old('users')) && in_array($user->id, old('users'))) || (!old('users') && $tournament->users->contains($user->id)) ? 'checked' : '' }}>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="score_correct_score"
                                        ...
                                        name="score_correct_score" :value="old('score_correct_score', $tournament->score_correct_score ?? 40)" required />
                                </div>
                                <div>
                                    ...
                                    <x-text-input id="score_correct_outcome"
                                        class="block mt-1 w-full bg-slate-700 border-gray-600 text-white" type="number"
                                        name="score_correct_outcome" :value="old('score_correct_outcome', $tournament->score_correct_outcome ?? 10)" required />
                                </div>
                                <div>
                                    ...
                                    <x-text-input id="score_goal_difference"
                                        class="block mt-1 w-full bg-slate-700 border-gray-600 text-white" type="number"
                                        name="score_goal_difference" :value="old('score_goal_difference', $tournament->score_goal_difference ?? 0)" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="score_wrong_outcome_penalty"
                                        class="block mt-1 w-full bg-slate-700 border-gray-600 text-white" type="number"
                                        name="score_wrong_outcome_penalty" :value="old('score_wrong_outcome_penalty', $tournament->score_wrong_outcome_penalty ?? 0)" required />
                        ...
                        <div class="mb-6 border-t border-white/10 pt-6">
                            ...
                            <label for="is_cashout_enabled" class="inline-flex items-center">
                                <input id="is_cashout_enabled" type="checkbox"
                                    ...
                                    name="is_cashout_enabled" value="1" {{ old('is_cashout_enabled', $tournament->is_cashout_enabled) ? 'checked' : '' }}>
                            ...
                            <div class="mt-4 flex flex-col gap-4">
                                <label for="is_double_down_enabled" class="inline-flex items-center">
                                    <input id="is_double_down_enabled" type="checkbox"
                                        class="rounded border-gray-600 bg-slate-700 text-pl-pink shadow-sm focus:ring-pl-pink"
                                        name="is_double_down_enabled" value="1" {{ old('is_double_down_enabled', $tournament->is_double_down_enabled) ? 'checked' : '' }}>
                                    <span
                                ...
                                <label for="is_defence_enabled" class="inline-flex items-center">
                                    <input id="is_defence_enabled" type="checkbox"
                                        class="rounded border-gray-600 bg-slate-700 text-pl-pink shadow-sm focus:ring-pl-pink"
                                        name="is_defence_enabled" value="1" {{ old('is_defence_enabled', $tournament->is_defence_enabled) ? 'checked' : '' }}>
                                    <span
                            ...
                            <div class="block mt-4 mb-4">
                                <label for="is_active" class="inline-flex items-center">
                                    <input id="is_active" type="checkbox"
                                        class="rounded border-gray-600 bg-slate-700 text-pl-pink shadow-sm focus:ring-pl-pink"
                                        name="is_active" value="1" {{ old('is_active', $tournament->is_active) ? 'checked' : '' }}>
